...
<br> <br> <br> <br> <br> <br> <br><li><a href="home.php">Home</a></li>
	...
	<div id="content">
		...
		<div id="main">
		        ...
		        <h1><?php echo " #".$_GET['tag']; ?>  Tweets</h1> 
                       		 <p>  
			...
			$result = mysqli_query($con,"select t.tweet_text, u.name , u.user_id from tweet t , tag a ,user u where u.user_id = t.user_id and t.tweet_id = a.tweet_id and t.user_id = a.user_id and a.tag = '$tag' order by t.tweet_id  ");
			
			while($row = mysqli_fetch_array($result))
			  {
			  	echo $row['name'] ."   @". $row['user_id'] ." - ". $row['tweet_text']; echo "<br>  <br>";
