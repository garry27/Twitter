...
<br> <br> <br> <br> <br> <br> <br><li><a href="home.php">Home</a></li>
	...
	<div id="content">
		...
		<div id="main">
			...
			<h1>You are currently following these users</h1>
			...
			$result = mysqli_query($con,"select f.following_id, u.name from user u,following f where u.user_id = f.following_id and f.user_id = '$userid' ");

			while($row = mysqli_fetch_array($result))
			  {
				echo "<a href='userprofile.php?followid=$row[following_id]'>"; 
			  	echo $row['name']; 
				echo "</a>";
				echo "<a href='unfollowprofile.php?followid=$row[following_id]'><center> <button>Unfollow </button></center></a>"; //echo "<br>  <br>";
